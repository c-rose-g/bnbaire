...
import {
	createReviewBySpotId,
	addReviewImageByReviewId,
} from '../../store/reviews';
...
function CreateReview() {
	...
	useEffect(() => {
		...
		if (review.length > 250) {
			errors.push('Reviews must be less than 250 characters.');
		}
		if (!stars) {
					...
					<div>
						<form className="review-form" onSubmit={submitReview}>
							...
							<div className="newreview-button-div">
								<button className="newreview-button" type="submit">
									submit
								</button>
							</div>
						</form>
